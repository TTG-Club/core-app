...
export function useGameCatalog() {
  ...
  //
  // `flush: 'sync'`: страница обнуляется в тот же тик, что и смена условий, —
  // тогда запрос выдачи и запись в адрес видят уже согласованную пару. С
  // отложенным сбросом со второй страницы уходил лишний запрос по старому
  // номеру, а следом сразу второй.
  watch(
    filter,
    () => {
      page.value = 0;
