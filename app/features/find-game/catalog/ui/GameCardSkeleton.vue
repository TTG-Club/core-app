<!-- Заглушка повторяет размеры карточки, чтобы сетка не дёргалась при загрузке. -->
<template>
  <div
    class="flex h-full flex-col overflow-hidden rounded-xl border border-default bg-elevated"
  >
