 ...
 *
 * Оружейный приём выбирается оружием: приём — свойство самого оружия, и списка
 * приёмов, из которого выбирали бы отдельно, у персонажа нет.
 */
...
export const FEAT_EDITOR_LABELS = {
  ...
  kindHint:
    ...
    + 'Оружие, приёмы оружия, категорию оружия, черту и «вариант» смешивать '
    + 'нельзя — их значения берутся из каталога, и в общей куче их не различить, '
    + 'поэтому такой вид остаётся в строке один.',
  kindSingleHint:
