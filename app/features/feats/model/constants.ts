...
export const FEAT_EDITOR_LABELS = {
  ...
  countersHintDetails:
    ...
    + '«с 3 уровня, 1 заряд», и до третьего уровня ресурса на листе нет. '
    + '«Минимум» подпирает формулу снизу: '
  ...
  counterScalingTitle: 'Заряды по уровням',
  counterScalingHint:
    'Первая ступень — уровень, с которого ресурс появляется; следующие — как '
    + 'растёт число зарядов. До первой ступени ресурса на листе нет, а поле '
    + '«Максимум» при ступенях не считается.',
  counterScalingEmpty:
    'Ступеней нет — ресурс есть с 1 уровня, заряды считаются по полю «Максимум».',
