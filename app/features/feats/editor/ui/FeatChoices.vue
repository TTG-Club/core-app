<script setup lang="ts">
   ...
   */
  const entries = computed<Array<{ choice: MechanicChoice; index: number }>>(
    () =>
      model.value
   ...
   * @returns url классов.
   */
  function getFilterClassUrls(filter: MechanicSpellFilter): Array<string> {
   ...
   */
  function getAbilityOptions(choice: MechanicChoice): Array<AbilityKey> {
   ...
   */
  function getKeyError(choice: MechanicChoice): string | undefined {
   ...
   */
  function getSpellListOptions(
    filter: MechanicSpellFilter,
  ): Array<SelectOption> {
   ...
   */
  function changeType(index: number, type: MechanicChoiceType | undefined) {
