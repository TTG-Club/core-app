...
/**
 * Работает ли явное срабатывание в месте формы.
 *
 ...
 * как эффект уйдёт жить отдельно. У действия существа и оружия — только цели. У
 * зоны мастера и у предмета источника нет.
 *
 * @param context место формы.
