...
/**
 * Окончание адреса статьи глоссария о навыке: статьи навыков лежат по
 * английскому ключу навыка из «Книги игрока» — `sleight-of-hand-phb`.
 */
export const SKILL_GLOSSARY_URL_SUFFIX = '-phb';
