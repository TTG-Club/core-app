<script setup lang="ts">
  import type { CreatureImmunities } from '../../../../model';
...
<template>
  ...
  >
    ...
    >
      <UInput
        v-model="immunities.text"
        placeholder="Введи отображаемый текст иммунитетов"
      />
    </UFormField>
  </UForm>
</template>
