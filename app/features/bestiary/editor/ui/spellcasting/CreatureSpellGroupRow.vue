<script setup lang="ts">
   ...
   * пустое поле «Перезарядка» у группы «По желанию» — вопрос, на который нет
  ...
  /** Сколько заклинаний в группе; ноль — бейдж не показывается. */
...
<template>
  ...
  >
    ...
    <!-- Поля группы строкой: их четыре, и часть показывается не всегда —
