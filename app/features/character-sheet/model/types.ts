...
/** Вид своего бонуса: модификатор характеристики или число. */
export type CustomBonusKind = 'ability' | 'flat';

/**
 * Источник своего бонуса одним значением — для селектора, где число и
 * характеристики стоят в общем списке: `flat` отвечает одноимённому виду,
 * ключ характеристики — виду `ability`.
 */
export type CustomBonusSource = AbilityKey | 'flat';
...
export interface CharacterSettings {
  ...
  /**
   * Свои бонусы мастерства сверх бонуса по уровню (пустой список — нет).
   * Складываются с бонусом по уровню везде, где тот участвует: спасброски,
   * навыки, атака оружием, заклинательство.
   */
  customProficiencyBonuses: CharacterCustomBonus[];

  /**
   * Свои бонусы инициативы сверх модификатора Ловкости (пустой список — нет).
   */
