...
export interface ArmorClassBreakdown {
  ...
  /**
   * Сумма прибавок от активных эффектов, чьё условие выполнено прямо сейчас:
   * «Оборона» даёт +1 только в доспехе, «Наручи защиты» +2 только без доспеха
   * и щита; 0 — подходящих эффектов нет.
   *
