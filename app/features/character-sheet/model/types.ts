...
export interface FeatSummary {
  ...
  /**
   * Выборы из `mechanics.choices`, которые лист умеет применить. Пока это
   * только компетентность в навыке: остальные виды выбора он не применяет и
   * потому не спрашивает. Пусто — черта ни о чём не спрашивает.
   */
  choices: ClassChoice[];
}
