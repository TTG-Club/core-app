export type {
  ...
  BugReportDiagnosticsClient,
  BugReportDiagnosticsDevice,
  BugReportDiagnosticsScene,
  BugReportDiagnosticsServer,
...
export { parseBugReportDiagnostics } from './diagnosticsSchema';
