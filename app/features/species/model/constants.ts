 ...
 *
 * Подписи не поминают ни вид, ни черту: тот же блок стоит в редакторе черт, и
 * строки в нём означают ровно то же самое.
 */
export const SPECIES_MECHANICS_EDITOR = {
  title: 'Влияние на лист персонажа',
  hint: 'Заполняется только то, что лист считает сам. Остальное — в описании.',
};
