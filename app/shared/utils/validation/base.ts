...
export const onlyRusString =
  /[^0-9\u{0410}-\u{044F}\u{401}\u{0451}\u{0020}\u{0027}\u{2010}-\u{2014}\u{002D}\u{0028}\u{0029}\u{002F}]/u;
...
export const onlyEngString =
  /[^0-9\u{0041}-\u{005A}\u{0061}-\u{007A}\u{0020}\u{0027}\u{2010}-\u{2014}\u{002D}\u{0028}\u{0029}\u{002F}]/u;
  ...
  return {
    ...
    validator: (rule: Rule, value: string) => {
      ...
      if (onlyRusString.test(value)) {
        throw new Error(
          'Допустимы только русские буквы, арабские цифры, круглые скобки, косая черта, дефис, апостроф и пробел',
        );
      }
  ...
  return {
    ...
    validator: (rule: Rule, value: string) => {
      ...
      if (onlyEngString.test(value)) {
        throw new Error(
          'Допустимы только английские буквы, арабские цифры, круглые скобки, косая черта, дефис, апостроф и пробел',
        );
      }
