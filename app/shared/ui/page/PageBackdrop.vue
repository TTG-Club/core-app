<!--
  Фон страницы из тех же приёмов, что шапка главной: тёплый свет сверху и
  волосяная клетка по краям. Только CSS — без анимации, чтобы не спорить с
  содержимым; частицы, если нужны, страница кладёт отдельно (HomeBackground).
...
<style lang="scss" module>
  /* Шаг клетки — мельче, чем в шапке главной: так она читается полем
     боевой карты, а не разлиновкой */
  $cell: 48px;
