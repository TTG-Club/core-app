...
/**
 * Тот же словарь, но с ключами в нижнем регистре — для поиска, нечувствительного к регистру.
 *
 * В данных встречаются опечатки вроде `{@I ...}` вместо `{@i ...}`; без этого маркер считается неизвестным и теряется вместе со своим текстом. Разные `type` в нижнем регистре не сталкиваются (`magicItem` → `magicitem`, псевдоним `magic-item` остаётся отдельным ключом).
 */
