...
| Domain           | Purpose                                                                                                                                                               | Sub-features                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `vttg`           | Marketing landing for the VTTG virtual tabletop (`/vttg`) + build downloads + master-password reset guide (`/vttg/reset-password`, linked from the VTTG login window) | `model` (`passwordReset` — guide steps per install: desktop, server archive; Docker is written but hidden until the build ships), `ui` (hero / features / FAQ / video sections, `VttgDownloadModal` — early-access notice behind the hero «Скачать» button, `VttgDownloadBuilds` — per-platform rows with their own version, `VttgGuideSteps` / `VttgGuideCode` — numbered guide steps with copyable commands), `composables` (`useVttgBuilds` — every build from the update channel)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
