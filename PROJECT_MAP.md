...
| `active-effects` | Shared «Активные эффекты» editor in the VTTG vocabulary (1:1 port of the dnd5e-2024 effect window) — one model + one step form for every section that changes sheet numbers: spells, feats, magic items, items, backgrounds, species, classes and creatures; the form layout depends on the editor place (`context`)                                                                                                                                                                                                                                                                                                                                     | `editor` (`ActiveEffects` list with live summary, step form: delivery, save with «Авто / Вручную» DC, damage, modifiers, duration, triggers with conditions), `model` (types, lenient Zod loading, `layout` by place, `triggers` & trigger conditions, live scenario, dictionaries & labels mirrored from the system, change & flag menus, PHB 2024 condition templates)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
