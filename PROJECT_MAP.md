...
| Domain       | Purpose                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Sub-features                                                                                                                                        |
| ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| `admin`      | Admin panel (`/admin`, ADMIN-only): dashboard tiles, top nav, live presence, character-sheet counts, game counts (total published games and the `CLOSED` subset from find-game-api; excludes drafts and soft-deleted games), personas, subscriptions & promo codes, bulk code mailing (`/admin/mailing`), scheduled Discord and Telegram game digests (`/admin/game-publications`: separate channels, digest preview and history tabs; up to 8 games across different systems with genres and links to new.ttg.club in one message per channel; names, systems, seats, genres and full links fit 2000 characters; descriptions are excluded from both preview and delivery; preview accepts the previous 10-game API response during deployment; global weekly Moscow schedule and per-channel overrides edited in Nuxt UI modals; platform selection, encrypted Discord webhook or numeric Telegram chat ID with a local show/hide button for the entered ID, manual channel test; shared schedule and separate platform rate limits; old /admin/discord-publications route retained; settings and dispatch in find-game-api, Telegram bot token in server environment only), users, home hero background (`/admin/home-hero`: a local draft of an image or webm, previewed in iframes of `/admin/home-hero/preview` sized to real screens — Full HD, 2K, laptop, phone — and scaled down, then published or reset to the default map). Pages also cover article CRUD (`articles/admin`) and tokenator frame upload/ordering | `character-sheets`, `dashboard`, `game-publications`, `games`, `home-hero`, `mailing`, `navigation`, `online`, `personas`, `subscriptions`, `users` |
