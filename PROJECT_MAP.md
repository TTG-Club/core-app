...
- **Composables** (`app/composables/`) — layout & navigation glue: the Wide/split
  ...
  `shared/ui/upload` and the character-sheet avatar), `useResizableHeight`,
  `useSidebarPopover` (19 in total).
