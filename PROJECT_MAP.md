...
| `home`     | Landing-page building blocks composed on `pages/index.vue`                                                                                 | `news`, `articles` (separate index block from `news`), `sections`, `banners`, `community`, `counters`, `greetings`, `recent-changes`, `background`, `social-links`, `link-to-5e14` |
...
| Domain       | Purpose                                                                                                                                                                                                         | Sub-features                                                              |
| ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| `admin`      | Admin panel (`/admin`, ADMIN-only): dashboard tiles, top nav, live presence, personas, subscriptions & promo codes, users. Pages also cover article CRUD (`articles/admin`) and tokenator frame upload/ordering | `dashboard`, `navigation`, `online`, `personas`, `subscriptions`, `users` |
